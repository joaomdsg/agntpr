---
name: packets-design
description: Use this skill to generate well-branded interfaces and assets for Packets (the agent-code control plane), either for production or throwaway prototypes/mocks/etc. Contains essential design guidelines, colors, type, fonts, assets, and a component catalog.
user-invocable: true
---
